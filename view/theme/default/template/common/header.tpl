...
// tel
 ...
 //Если ошибок нет, отправить email
  if(!isset($hasError)) {
  $emailTo = '1lavrov1@ukr.net'; //Сюда введите Ваш email
  $body = "Имя: $name \n\nТелефон: $phone \n\nТема: $subject \n\nУдобное время: $time";
...
<input type="text" size="13" name="phone" id="phone" value="" class="required" />
  ...
  <div class="contact">
  	<a href="#" class="header_phone"><span>(093)</span> 544 - 44 - 35</a>
  	<p>Ежедневно с 9:00 до 11:01</p><div class="call">Заказать звонок</div>
  </div>
