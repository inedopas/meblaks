...
$data='<?xml version="1.0" encoding="UTF-8"?><?xml-stylesheet type="text/xsl" href="/sitemap/xsl/sitemap-index.xsl"?><sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">';
...
if($prodstyle == '1'){
$sitemap_index .='<?xml-stylesheet type="text/xsl" href="/sitemap/'.$store_id.'/products/xsl/sitemap-index.xsl"?>';
}
...
if($prodstyle == '1'){
$data .='<?xml-stylesheet type="text/xsl" href="/sitemap/'.$store_id.'/products/xsl/sitemap.xsl"?>';
}
...
$sitemap_index='<?xml version="1.0" encoding="UTF-8"?>';
if($prodstyle == '1'){
$sitemap_index .='<?xml-stylesheet type="text/xsl" href="/sitemap/'.$store_id.'/categories/xsl/sitemap-index.xsl"?>';
}
$sitemap_index .='<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">';
...
$data='<?xml version="1.0" encoding="UTF-8"?>';
if($prodstyle == '1'){
$data .='<?xml-stylesheet type="text/xsl" href="/sitemap/'.$store_id.'/categories/xsl/sitemap.xsl"?>';
}
$data .='<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1">';
...
if($prodstyle==1){
$sitemap_index .='<?xml-stylesheet type="text/xsl" href="/sitemap/'.$store_id.'/brands/xsl/sitemap-index.xsl"?>';
}
$sitemap_index .='<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">';
...
if($prodstyle==1){
$data .='<?xml-stylesheet type="text/xsl" href="/sitemap/'.$store_id.'/brands/xsl/sitemap.xsl"?>';
}
$data .='<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1">';
...
$sitemap_index='<?xml version="1.0" encoding="UTF-8"?>';
if($prodstyle==1){
$sitemap_index .='<?xml-stylesheet type="text/xsl" href="/sitemap/'.$store_id.'/information/xsl/sitemap-index.xsl"?>';
}
$sitemap_index .='<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">';
...
$data='<?xml version="1.0" encoding="UTF-8"?>';
if($prodstyle==1){
$data .='<?xml-stylesheet type="text/xsl" href="/sitemap/'.$store_id.'/information/xsl/sitemap.xsl"?>';
}
$data .='<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1">';
$status=($statusd==0)? ' status=1 AND ' : '';
...
if($prodstyle==1){
$data .='<?xml-stylesheet type="text/xsl" href="/sitemap/'.$store_id.'/pages/xsl/sitemap.xsl"?>';
}
$data .='<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1">
