...
<div id="content">
  ...
  <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> Cosyone Theme v2.5</h3>
      </div>
...
<option value="<?php echo $key;?>" <?php if($cosyone_header_wishlist==$key) { echo " selected"; }?> ><?php echo $cosyone_header_wishlist_list;?></option>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
    <input type="text" class="form-control" value="<?php echo isset($cosyone_custom_menu_title3[$language['code']]) ? $cosyone_custom_menu_title3[$language['code']] : ''; ?>" name="cosyone_custom_menu_title3[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    <span class="help-block">* Leave it blank to disable the link</span>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
    <input type="text" class="form-control" value="<?php echo isset($cosyone_custom_menu_title4[$language['code']]) ? $cosyone_custom_menu_title4[$language['code']] : ''; ?>" name="cosyone_custom_menu_title4[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    <span class="help-block">* Leave it blank to disable the link</span>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
    <input type="text" class="form-control" value="<?php echo isset($cosyone_custom_menu_title5[$language['code']]) ? $cosyone_custom_menu_title5[$language['code']] : ''; ?>" name="cosyone_custom_menu_title5[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    <span class="help-block">* Leave it blank to disable the link</span>
    </div>
