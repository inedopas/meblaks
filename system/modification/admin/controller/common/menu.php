...
$this->load->language('catalog/tab');
		...
		$data['text_uninstaller'] = 'Удаление модулей';
    ...
    // OCFilter start
		...
		$data['uninstaller'] = $this->url->link('extension/installer/do_uninstall', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['openbay_link_amazonus_links'] = $this->url->link('openbay/amazonus/itemlinks', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $data['text_promotion_label_pro'] = 'Promotion Label PRO';
            $data['text_label_manager'] = 'Label Manager';
            $data['text_product_to_label'] = 'Product to Label';
            $data['label_manager'] = $this->url->link('catalog/promotion_label_pro', 'token=' . $this->session->data['token'], 'SSL');
            $data['product_to_label'] = $this->url->link('catalog/promotion_label_to_product', 'token=' . $this->session->data['token'], 'SSL');
