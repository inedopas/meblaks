...
'filter_sku'	  => $filter_sku, // customized
...
$data['entry_sku'] = $this->language->get('entry_sku'); // customized
		...
		$data['sort_name'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
                ...
                $data['sort_category'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=p2c.product_id' . $url, 'SSL');						
...
$data['filter_sku'] = $filter_sku; // customized
