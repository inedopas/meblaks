...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		...
		foreach ($data['category_description'] as $language_id => $value) {
			$value['meta_title'] = $value['name'].' купить недорого в Киеве, Черкассах с доставкой по Украине - Meblaks';
			$value['meta_description'] = 'Интернет - магазин мебели Meblaks предлагает купить '.$value['name'].' > Лучшая цена, гарантия, отзывы, доставка в Киев, Черкассы, Харьков, Одессу, Днепр, Украине';
			$value['meta_keyword'] = $value['name'].', '.$value['name'].' купить, '.$value['name'].' цена, '.$value['name'].' заказать';
