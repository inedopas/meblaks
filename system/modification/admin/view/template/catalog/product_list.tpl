          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                ...
                <td class="text-right"><?php if ($sort == 'p2c.product_id') { ?>
                    ...
                    <?php } ?></td>
                <td class="text-right"><?php if ($sort == 'p.manufacturer_id') { ?>
              ...
              <tbody>
                ...
                <td class="text-left"><?php if ($product['manufacturer']) {
                    echo $product['manufacturer']['name']; }?></td>
