...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if(isset($this->request->get['route'] ) and $this->request->get['route'] == 'product/manufacturer') {
			$data['title'] = 'Бренды интернет-магазина мебели Meblaks';
			$data['description'] = 'Интернет магазин мебели meblaks.com.ua предлагает купить мебель лучших брендов по низким ценам ☎ 38 (067) 252-60-66';
			$data['keywords'] = 'Бренды мебели, производители мебели';
		} else {
