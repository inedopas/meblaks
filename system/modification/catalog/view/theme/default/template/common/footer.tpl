<?php echo $footer_modules ?>
        ...
        <?php global $registry; $vie_module_groups = $registry->get('vie_module_groups'); if (!empty($vie_module_groups['vie_ft'])) { ?>
...
<div id="footer">
 ...
 <div class="container">
        ...
        <?php global $registry; $vie_module_groups = $registry->get('vie_module_groups'); if (!empty($vie_module_groups['vie_fct'])) { ?>
