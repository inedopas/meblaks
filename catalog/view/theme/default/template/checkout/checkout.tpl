			   ...
			   <?php //}?>
				...
				<div class="your_order">
					...
					<div class="payment clearfix">
					    ...
					    <input type="button" class="btn btn-primary" data-loading-text="<?php if (isset($text_loading)) echo $text_loading;else echo 'loading ...' ?>" id="button-register"onclick="ga('send', 'pageview', '/virtual/oformitzakaz');" value="<?php echo $heading_title;?>">
					    <?php }?></div>
					</div>
			    </div>
			</div>
