...
<div class="box filter_holder clearfix">
...
<div class="box" id="adv_ajaxfilter_box">
    ...
    <div class="bordered_content">
        ...
        <form id="adv_ajaxfilter" class="clearfix">
            <div class="option_box  col-sm-3" <?php if(!$instock_visible) echo 'style="display:none"'; ?>>
            ...
            <div class="option_box  col-sm-3" <?php if(!$price_slider) { echo 'style="display:none"';}?>>
            ...
            <div class="option_box  col-sm-3">
                ...
                <?php } ?>
                    ...
                    <div class="attribute_box <?php if($attr_group=="0") echo "option_box  col-sm-3"; ?>">
