...
<div class="container">
    ...
    <div id="coicons_absolutentent" class="product" itemscope itemtype="http://data-vocabulary.org/Product">
        ...
        <div class="product-info clearfix">
            ...
            <div class="col-xs-12">
                ...
                <div class="col-sm-6">
                    <div class="image">
                        ...
                        <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom"
                           style="cursor:move" rel="position:'inside', showTitle: false" id='zoom1'><img
                                    itemprop="image" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>"
                                    alt="<?php echo $heading_title; ?>"/></a>
                        <!-- zoom link-->
                        <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" id="zoom-btn"
                           class="colorbox" rel="colorbox"><i class="fa fa-search-plus"></i></a>
                        <?php } else { ?>
                    ...
                    <div class="image-additional"
                         style="width:<?php echo $thumb_width; ?>px; height:<?php echo $additional_height; ?>px">
                        <ul class="image_carousel">
                                ...
                                <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"
                                   ...
                                   rel="useZoom: 'zoom1', smallImage: '<?php echo $image['thumb']; ?>'">
                                    ...
                                    <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>"
                                       ...
                                       rel="useZoom: 'zoom1', smallImage: '<?php echo $image['thumb']; ?>'">
                                        <?php } ?>
                                        <img src="<?php echo $image['small']; ?>" title="<?php echo $heading_title; ?>"
                                             width="<?php echo $additional_width; ?>"
                                             height="<?php echo $additional_height; ?>"
                            ...
                            <li><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"
                                   class="cloud-zoom-gallery colorbox"
                                   rel="useZoom: 'zoom1', smallImage: '<?php echo $thumb; ?>'"><img
                                            src="<?php echo $small; ?>" title="<?php echo $heading_title; ?>"
                                            alt="<?php echo $heading_title; ?>" width="<?php echo $additional_width; ?>"
                                            height="<?php echo $additional_height; ?>"/></a></li>
                            <?php } ?>
                        </ul>
          ...
          if($manufacturer=='Биформер') { ?>
                                ...
                                <span class="mainprice"><?php echo $price; ?></span> <span class="mainprice"
                                                                                           itemprop="price"><span
                            ...
                            <span class="zakazat"><button type="submit"
                                                          onclick="ga('send', 'pageview', '/virtual/addtocart');"
                                                          id="button-cart"
                                                          data-loading-text="<?php echo $text_loading; ?>"
                                                          class=""><?php echo $button_cart; ?></button></span>
                        </div>
                  ...
                  <a class="sq_icon compare" onclick="compare.add('<?php echo $product_id; ?>');" data-tooltip="<?php echo $button_compare; ?>"><i class="fa fa-arrow-right"></i><i class="fa fa-arrow-left main_compare"></i></a>
                        ...
                        <div class="options">
                            ...
                            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                <label class="control-label"
                                       for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?></label>
                                <div id="input-option<?php echo $option['product_option_id']; ?>"
                                     class="clean-option-image">
                                    <?php foreach ($option['product_option_value'] as $option_value) { ?>
                                    <div class="single-option main_font"
                                    <?php if ($option_value['price']) { ?>
                                    data-tooltip="<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>
                                    "<?php } ?>>
                                    <input type="radio" name="option[<?php echo $option['product_option_id']; ?>]"
                                           value="<?php echo $option_value['product_option_value_id']; ?>"
                                           id="option-value-<?php echo $option_value['product_option_value_id']; ?>"/><label
                                            for="option-value-<?php echo $option_value['product_option_value_id']; ?>"><img
                                                src="<?php echo $option_value['image']; ?>"
                                                alt="<?php echo $option_value['name']; ?>"/></label>
                                </div>
                                <?php } ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                            ...
                            <button type="button" id="button-upload<?php echo $option['product_option_id']; ?>"
                                    data-loading-text="<?php echo $text_loading; ?>" class="button"><i
                ...
                <div class="descr">
                    ...
                    <div class="manufacturer">
                        <span class=""><?php echo $text_manufacturer; ?></span> <a class="small_text"
       ...
       <span>
        ...
        <span itemprop="rating" content="<?php echo $rating; ?>"></span><span itemprop="count"
                                                                              content="<?php echo $reviews; ?>"></span>
        </div>
    ...
    <ul class="nav nav-tabs product-page">
        ...
        <li><a href="#tab-product-tab<?php echo $product_tab_5['tab_id'];?>"
               data-toggle="tab"><?php echo $product_tab_5['name']; ?></a></li>
        <?php } ?>
        <?php } ?>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="tab-delivery">
            <div class="delivery">
                <div class="container"><p><strong>«Меблакс»</strong> предлагает Вам все преимущества покупок через
                        интернет с возможностью получения товара в удобном для Вас месте и в удобное время.</p>


                    <p class="h2" style="text-align:center;">Варианты доставки</p>


                    <p><strong>Курьерская доставка в городе Черкассы (при наличии товара на складе в городе
                            Черкассы)</strong><br>При оформлении покупки Вы согласовываете с оператором магазина дату и
                        адрес доставки. В назначенный день наш курьер свяжется с вами и уточнит удобное для вас время
                        доставки. При получении заказа вам необходимо иметь при себе паспорт, а юридическому лицу –
                        кроме документа, удостоверяющего личность, доверенность на получение товара. Стоимость
                        курьерской доставки 50,00 грн. При оформлении заказа свыше 1000,00 грн – курьерская доставка
                        <strong>бесплатна!</strong>Курьерская доставка осуществляется до подъезда либо ворот жилого
                        дома.</p>


                    <p><strong>Доставка по Украине транспортными компаниями согласно их тарифов</strong><br>Мы можем
                        выслать Вам товар любым удобным для вас перевозчиком:<br>
                    </p>
                    ...
                    <br>
                    Стоимость доставки рассчитывается транспортной компанией исходя из массы и габаритов товара, а также
                    в зависимости от выбранного вами типа доставки: на склад перевозчика или адресная доставка. Доставку
                    вы оплачиваете самостоятельно по прибытии заказа в Ваш населенный пункт.<p></p>


                    <p class="h2" style="text-align:center;">Строки доставки</p>


                    <p>Сроки доставки необходимо уточнять у менеджера. Если товар имеется в наличии на складе, Вам его
                        доставят в течение 2-3 дней. При отсутствии необходимого товара на складе, оператор магазина
                        сообщит вам сроки выполнения заказа.</p>


                    <p class="h2" style="text-align:center;">Проверка товара</p>


                    <p>Получить Ваш заказ со склада перевозчика или при адресной доставке Вы сможете, предъявив свой
                        паспорт и номер декларации.</p>


                    <p class="h2" style="text-align:center;">После доставки товара к Вам, внимательно осмотрите
                        целостность упаковки самого изделия.</p>


                    <p>- проверьте упаковку на наличие сколов и потертостей;<br>- при получении товара, обязательно
                        проверяйте количество доставленных коробок, они должны соответствовать количеству заявленном в
                        ТТН;<br>- убедитесь в том, что изделие укомплектовано необходимой фурнитурой и крепежными
                        элементами;<br>- тщательно осмотрите стеклянные детали.</p>


                    <p>Мы ценим время и нервы своих клиентов, поэтому весь наш товар проходит тщательную проверку перед
                        отправкой со склада. Условия гарантийного обслуживания смотрите в разделе <a href="/Guarantees">«Гарантии»</a>.
                    </p>

                    <p class="h2" style="text-align:center;">Оплата</p>
                    <p>Заказ является принятым в работу только после предоплаты на карту интернет-магазина. Полная
                        оплата может осуществляться следующими способами:</p>
                    ...
                    <p>Подходит для пользователей сервиса Приват 24. Вы можете произвести оплату своего заказа
                        посредством данной системы, переведя необходимую сумму денег на карту интернет-магазина.
                        (комиссия 0,5%)</p>
                    <p class="h2" style="text-align:center;">Через платежный терминал</p>
                    <p>Вы можете оплатить свою покупку через любой терминал самообслуживания, сделав денежный перевод на
                        карточку интернет-магазина. (комиссия 1-2% в зависимости от банка плательщика)</p>
            ...
            <form id="form-review" class="form-horizontal">
                ...
                <div class="write_review contrast_font">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6"><a id="button-review"
                                                 class="button pull-right"><?php echo $button_continue; ?></a></div>
                    </div>
                </div>
                <?php } else { ?>
